...
const BLOCK_METADATA: BlockMetadata[] = [
    ...
    },
    {
        ...
        icon: Wrench,
        title: "Design Fixer",
        description: "Identify and fix design issues in examples",
        category: "interactive",
    },
    {
        type: "playerTypeSimulator",
        icon: Users,
        title: "Player Type Simulator",
        description: "Explore different player types and motivations",
        category: "interactive",
    },
    {
        ...
        description: "Design and test reward schedules",
        category: "interactive",
    },
    {
        ...
        description: "Evaluate flow state and challenge-skill balance",
        category: "interactive",
    },
    {
        type: "pitchAnalysisGenerator",
        icon: Mic,
        title: "Pitch Analysis Generator",
        description: "Analyze and improve pitch presentations",
        category: "interactive",
    },
    {
    ...
    },
    {
        ...
        description: "Identify and redesign dark patterns",
        category: "interactive",
    },
    {
        type: "roeDashboard",
        icon: PieChart,
        title: "ROE Dashboard",
        description: "Return on Engagement analytics dashboard",
        category: "interactive",
    },
    {
        ...
        description: "Visualize learning journeys and timelines",
        category: "interactive",
    },
    {
